...
public class WordLists {
	...
	/** The AUXILIARIES. */
	public static List<String> AUXILIARIES = Arrays.asList(new String[] { "do",
			"have", "be" });

	/** List of verbs that take consonant doubling. */
	public static List<String> VERB_CONS_DOUBLING = Arrays.asList(new String[] {
	...
	public static List<String> MODALS = Arrays.asList(new String[] { "shall",
	...
	/** The NUL l_ plural. */
	public static List<String> NULL_PLURAL = Arrays.asList("Bantu",
			"Bengalese", "Bengali", "Beninese", "Boche", "bonsai", "Burmese",
			...
			"Sudanese", "Swiss", "Taiwanese", "Togolese", "Vietnamese",
			"aircraft", "anopheles", "apparatus", "asparagus", "barracks",
			"bellows", "bison", "bluefish", "bob", "bourgeois", "bream",
			"brill", "butterfingers", "carp", "catfish", "chassis", "clothes",
			"chub", "cod", "codfish", "coley", "contretemps", "corps",
			"crawfish", "crayfish", "crossroads", "cuttlefish", "dace", "dice",
			"dogfish", "doings", "dory", "downstairs", "eldest", "earnings",
			"economics", "electronics", "finnan", "firstborn", "fish",
			"flatfish", "flounder", "fowl", "fry", "fries", "works",
			"globefish", "goldfish", "grief", "grand", "gudgeon", "gulden",
			"haddock", "hake", "halibut", "headquarters", "herring", "hertz",
			"horsepower", "hovercraft", "hundredweight", "ironworks",
			"jackanapes", "kilohertz", "kurus", "kwacha", "ling", "lungfish",
			"mackerel", "means", "megahertz", "moorfowl", "moorgame", "mullet",
			"nepalese", "offspring", "pampas", "parr", "patois", "pekinese",
			"penn'orth", "perch", "pickerel", "pike", "pince-nez", "plaice",
			"precis", "quid", "rand", "rendezvous", "revers", "roach", "roux",
			"salmon", "samurai", "series", "seychelles", "seychellois", "shad",
			"sheep", "shellfish", "smelt", "spacecraft", "species", "starfish",
			"stockfish", "sunfish", "superficies", "sweepstakes", "swordfish",
			"tench", "tope", "triceps", "trout", "tuna", "tunafish", "tunny",
			"turbot", "undersigned", "veg", "waterfowl", "waterworks",
			"waxworks", "whiting", "wildfowl", "woodworm", "yen", "aries",
			"pisces", "forceps", "lieder");
